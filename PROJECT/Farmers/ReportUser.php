...
<?php
$sql="select * from tbl_retailer where retailer_id='".$rid."'";
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="container" style="  width: 600px; height: 40px;;border: 1px solid gray; padding: 10px"><?php echo  $data["retailer_name"];?></div>
