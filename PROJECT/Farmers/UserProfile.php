...
<body>
  ...
  <div class="breadcrumbs">
   ...
   <?php
    $headQry="select * from tbl_retailer where retailer_id='".$rid."'";
            ...
            <div class="col-lg-3 col-md-12 col-12">
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-menu">
                                ...
                                <div class="button">
                                                <a class="btn" href="ReportUser.php?rid=<?php echo $dataH["retailer_id"]; ?>">Report User</a>
                                            </div>
                ...
                <div class="col-lg-9 col-md-12 col-12">
                    ...
                    <div class="col-12">
                            ...
                            <div class="row">
                    <?php
$disQry="select * from tbl_request a inner join  tbl_category c on a.category_id=c.category_id inner join tbl_retailer f on a.retailer_id=f.retailer_id inner join tbl_place p on p.place_id=f.place_id  inner join tbl_district d on p.district_id=d.district_id where f.retailer_id='".$rid."'ORDER BY request_id DESC";
