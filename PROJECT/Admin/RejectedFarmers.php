...
<body>
<div class="container">
    <h1 class="text-center">Rejected Farmers</h1>
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                $selQry="select * from tbl_farmer f inner join tbl_place p on p.place_id=f.place_id  inner join tbl_district d on p.district_id=d.district_id where farmer_vstatus=2";
