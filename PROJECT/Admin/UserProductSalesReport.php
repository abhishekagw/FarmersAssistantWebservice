...
<form id="form1" name="form1" method="post" action="">
  ...
  <table  border="1" cellpadding="10" align="center">
    ...
    <?php
	$sel="select * from tbl_booking c inner join tbl_product p on c.product_id=p.product_id   inner join tbl_retailer u on u.retailer_id=c.retailer_id where payment_status='1' and booking_date between '".$_POST["txt_f"]."' and '".$_POST["txt_t"]."'";
	$row=$con->query($sel);
	$i=0;
