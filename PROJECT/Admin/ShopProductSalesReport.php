...
<form id="form1" name="form1" method="post" action="">
  ...
  <table  border="1" cellpadding="10" align="center">
    ...
    <?php
	$sel="select * from tbl_cart c inner join tbl_product p on c.product_id=p.product_id  inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_shop u on u.shop_id=b.shop_id where payment_status='1' and booking_date between '".$_POST["txt_f"]."' and '".$_POST["txt_t"]."'";
	$row=$conn->query($sel);
	$i=0;
