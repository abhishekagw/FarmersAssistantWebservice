...
if(isset($_POST["btn_register"]))
{
  ...
  if($eQry->num_rows<1)
  {
      ...
      {
      $insQry="insert into tbl_retailer(retailer_name,retailer_email,retailer_contact,retailer_address,retailer_password,retailer_proof,retailer_photo,place_id,retailer_date) values('".$name."','".$email."',".$contact.",'".$address."','".$password."','".$proof."','".$photo."','".$place."',curdate())";
      $con->query($insQry);
      $otp=rand(1000,9999);
                    ...
                    <h4 class="title">Registration</h4>
                     <form class="default-form-style" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" name="regform">
                        ...
                        <label for="file_photo" class="custom-file-upload"
                            ...
                            <input type="file" id="file_photo" name="file_photo" style="display: none;">
                            <i class="lni lni-cloud-upload" style="margin-right: 5px;"></i> Upload File
                        </label></div><br><br>
                        <label>Proofs</label><br>
                        <label for="file_proof" class="custom-file-upload"
                            style="border: 2px solid #ccc; border-radius: 5px; padding: 10px; display: inline-block; cursor: pointer;">
                            <input type="file" id="file_proof" name="file_proof" style="display: none;">
                            <i class="lni lni-cloud-upload" style="margin-right: 5px;"></i> Upload File
                        </label><br>
