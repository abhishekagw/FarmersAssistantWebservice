...
if(isset($_POST['btn_submit']) ) 
{
    ...
    $insQry="insert into tbl_contactus(contactus_name,contactus_subject,contactus_email,contactus_phone,contactus_message,contactus_retailerid)values('".$name."','".$subject."','".$email."','".$phone."','".$message."','".$_SESSION["rid"]."')";
    if($con->query($insQry))
    {
