...
<form id="form1" name="form1" method="post" action="">
      ...
      <h2 align="center">Please Rate us</h2>
      <div class="container">
...
$(document).ready(function(){
 ...
 var rating_data = 0;
  ...
  <table border="1" align="center">
    <tr>
      <td><h3 align="center">Suggestion</h3>
        <p>
          <label for="txt_suggestion"></label>
          <textarea name="txt_suggestion" id="txt_suggestion" cols="45" rows="5"></textarea>
      </p></td>
    </tr>
    <tr>
      <td><div align="center">
